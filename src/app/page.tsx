            ...
            <div className="max-w-3xl mx-auto bg-white border-4 border-red-500 shadow-2xl p-2 sm:p-4 rounded-lg">
              <div className="pt-0 sm:pt-1 pb-6 sm:pb-6 px-3 sm:px-4">
                ...
                {stagePage === 1 && (
                  <div className="space-y-3 sm:space-y-4">
                    ...
                    <div className="bg-red-100 border-2 border-red-300 p-3 sm:p-4 rounded">
                      ...
                      <p className="text-xs sm:text-sm text-gray-600 mt-2 text-right">— Romans 3:23 (ESV)</p>
                    </div>
                    <p className="text-sm sm:text-lg leading-snug sm:leading-relaxed text-gray-800">
                ...
                {stagePage === 2 && (
                  <div className="space-y-3 sm:space-y-4">
                    ...
                    <div className="bg-red-100 border-2 border-red-300 p-3 sm:p-4 rounded">
                      ...
                      <p className="text-xs sm:text-sm text-gray-600 mt-2 text-right">— Romans 6:23a (ESV)</p>
                    </div>
                    <p className="text-sm sm:text-lg leading-snug sm:leading-relaxed text-gray-800">
                ...
                <div className="flex gap-2 mt-4 justify-between">
                  ...
                  {stagePage > 0 && stagePage < 3 && (
                    <button onClick={nextPage} className="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">
                      Next →
                    </button>
                  )}
                  {stagePage === 0 && (
                    <button onClick={nextPage} className="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 ml-auto">
                      Next →
                    </button>
                  )}
                  {stagePage === 3 && (
                    <button onClick={nextStage} className="px-6 py-2 bg-red-600 text-white rounded hover:bg-red-700 flex items-center gap-2 ml-auto">
            ...
            <div className="max-w-3xl mx-auto bg-white border-4 border-blue-500 shadow-2xl p-2 sm:p-4 rounded-lg">
              <div className="pt-0 sm:pt-1 pb-6 sm:pb-6 px-3 sm:px-4">
                ...
                {stagePage === 1 && (
                  <div className="space-y-3 sm:space-y-4">
                    ...
                    <div className="bg-blue-100 border-2 border-blue-300 p-3 sm:p-4 rounded">
                      ...
                      <p className="text-xs sm:text-sm text-gray-600 mt-2 text-right">— John 3:16 (ESV)</p>
                    </div>
                    <p className="text-sm sm:text-lg leading-snug sm:leading-relaxed text-gray-800">
                      Jesus lived a perfect life. He never sinned—not even once! Then Jesus died on the cross. When He died, He took the punishment that WE deserved.
                    </p>
                  </div>
                )}
                {stagePage === 2 && (
                  <div className="space-y-3 sm:space-y-4">
                    ...
                    <div className="bg-blue-100 border-2 border-blue-300 p-3 sm:p-4 rounded">
                      ...
                      <p className="text-xs sm:text-sm text-gray-600 mt-2 text-right">— 1 Peter 2:24 (ESV)</p>
                    </div>
                    <p className="text-sm sm:text-lg leading-snug sm:leading-relaxed text-gray-800">
                      Jesus took God's anger against our sin upon Himself. But that's not the end! Three days later, Jesus came back to life!
                    </p>
                  </div>
                )}
                {stagePage === 3 && (
                  <div className="space-y-3 sm:space-y-4">
                    ...
                    <div className="bg-blue-100 border-2 border-blue-300 p-3 sm:p-4 rounded">
                      ...
                      <p className="text-xs sm:text-sm text-gray-600 mt-2 text-right">— John 14:6 (ESV)</p>
                    </div>
                    <p className="text-sm sm:text-lg leading-snug sm:leading-relaxed text-gray-800">
                      He conquered death and sin. Jesus is alive right now in heaven, and He is the ONLY way to be saved and have friendship with God forever.
                    </p>
                  </div>
                )}
                {stagePage === 4 && (
                ...
                <div className="flex gap-2 mt-4 justify-between">
                  ...
                  {stagePage > 0 && stagePage < 4 && (
                    <button onClick={nextPage} className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                      Next →
                    </button>
                  )}
                  {stagePage === 0 && (
                    <button onClick={nextPage} className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 ml-auto">
                      Next →
                    </button>
                  )}
                  {stagePage === 4 && (
                    <button onClick={nextStage} className="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 flex items-center gap-2 ml-auto">
            ...
            <div className="max-w-3xl mx-auto bg-white border-4 border-green-500 shadow-2xl p-2 sm:p-4 rounded-lg">
              <div className="pt-0 sm:pt-1 pb-6 sm:pb-6 px-3 sm:px-4 space-y-3 sm:space-y-4">
                ...
                <div className="flex gap-2 mt-4 justify-between">
                  ...
                  {stagePage > 0 && stagePage < 3 && (
                    <button onClick={nextPage} className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700">
                      Next →
                    </button>
                  )}
                  {stagePage === 0 && (
                    <button onClick={nextPage} className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 ml-auto">
                      Next →
                    </button>
                  )}
                </div>
            ...
            <div className="max-w-3xl mx-auto bg-white border-4 border-yellow-500 shadow-2xl p-2 sm:p-4 rounded-lg">
              <div className="pt-0 sm:pt-1 pb-6 sm:pb-6 px-3 sm:px-4 space-y-3 sm:space-y-4">
                ...
                <div className="flex gap-2 mt-4 justify-between">
                  ...
                  {stagePage > 0 && stagePage < 2 && (
                    <button onClick={nextPage} className="px-4 py-2 bg-yellow-600 text-white rounded hover:bg-yellow-700">
                      Next →
                    </button>
                  )}
                  {stagePage === 0 && (
                    <button onClick={nextPage} className="px-4 py-2 bg-yellow-600 text-white rounded hover:bg-yellow-700 ml-auto">
                      Next →
                    </button>
                  )}
                </div>
